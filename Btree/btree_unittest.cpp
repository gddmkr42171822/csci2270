...
/*TEST_BEGIN("My insert")
{
	...
	IsTrue("10 inserted properly", root->keys[0] == 10, "No good");
	IsTrue("20 inserted properly", root->keys[1] == 20, "No good");
	IsTrue("30 inserted properly", root->keys[2] == 30, "No good");
	IsTrue("40 inserted properly", root->keys[3] == 40, "No good");
	IsTrue("root num_keys is 4", root->num_keys == 4, "no good");
	
	insert(root, 38);
	IsTrue("30 is in the right place", root->keys[0] == 30, "No good");
	IsTrue("10 is in the right place", root->children[0]->keys[0] == 10, "No good");
	IsTrue("20 is in the right place", root->children[0]->keys[1] == 20, "No good");
	IsTrue("38 is in the right place", root->children[1]->keys[0] == 38, "No good");
	IsTrue("40 is in the right place", root->children[1]->keys[1] == 40, "No good");
	IsTrue("root has right numkeys", root->num_keys == 1, "No good");
	IsTrue("child 1 has right numkeys", root->children[0]->num_keys == 2, "No good");
	IsTrue("child 2 has right numkeys", root->children[1]->num_keys == 2, "No good");
	
	insert(root,25);
	insert(root,5);
	IsTrue("25 is in the right place", root->children[0]->keys[3] == 25, "No good");
	IsTrue("5 is in the right place", root->children[0]->keys[0] == 5, "No good");
	IsTrue("first child has right number of keys", root->children[0]->num_keys == 4, "No good");
	IsTrue("root has right numkeys", root->num_keys == 1, "No good");
	IsTrue("second child has right number of keys", root->children[1]->num_keys == 2, "No good");
	
	insert(root, 22);
	IsTrue("root has 2 num_keys", root->num_keys == 2, "no good");
	IsTrue("child 3 has 2 num_keys", root->children[2]->num_keys == 2, "no good");
	IsTrue("child 2 has 2 num_keys", root->children[1]->num_keys == 2, "no good");
	IsTrue("child 1 has 2 num_keys", root->children[0]->num_keys == 2, "no good");
	
	insert(root, 7);
	insert(root, 15);
	IsTrue("child 1 has 4 num_keys", root->children[0]->num_keys == 4, "no good");
	
	insert(root, 26);
	insert(root, 28);
	IsTrue("child 2 has 4 num_keys", root->children[1]->num_keys == 4, "no good");
	
	insert(root, 43);
	insert(root, 45);
	IsTrue("child 3 has 4 num_keys", root->children[2]->num_keys == 4, "no good");
	
	insert(root, 21);
	IsTrue("root has 3 keys", root->num_keys == 3, "no good");
	IsTrue("child 3 has 2 num_keys", root->children[2]->num_keys == 2, "no good");
	IsTrue("child 2 has 2 num_keys", root->children[1]->num_keys == 2, "no good");
	
	insert(root,47);
	IsTrue("child 4 has 2 num_keys", root->children[3]->num_keys == 2, "no good");
	IsTrue("child 3 has 2 num_keys", root->children[2]->num_keys == 2, "no good");
