...
int main () {
  ...
  //insert data into nodes depending on offest
  //insert_data(&head, 0, 6);
  //cout << "Nodes should look like 6, 5, 32, 99: " << report(head) << endl;
  //remove(&head, 2);
  //cout << "Nodes should look like 6, 5, 99: " << report(head) << endl;
  cout << report(head) << endl;
  cout << size(head) << endl;
   //cout << "Nodes in list : " << report(head) << endl;
  //cout << "Value looking for 53." << endl;
  contains(head, 99);
